...
export interface Mutation {
  ...
  login?: User | null; /** Login mechanism for the gateway */
  logout?: boolean | null; /** Logout mechanism for the gateway */
}
...
export namespace MutationResolvers {
  export interface Resolvers {
    ...
    login?: LoginResolver; /** Login mechanism for the gateway */
    logout?: LogoutResolver; /** Logout mechanism for the gateway */
  }
