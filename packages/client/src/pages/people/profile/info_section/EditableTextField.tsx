...
class EditableTextField extends React.PureComponent<IEditableTextFieldWithApollo> {
    ...
    private executeMutate = debounce(((userID: string, value: string) => {
        ...
        // in case  we debounce a mutation after a gateway error, clear the error
        ...
        // note in below that client errors always supercede gateway errors because
        ...
        return this.client.mutate({
            ...
            if (this.state.status !== Status.CLIENT_ERROR) {
                ...
                this.setState({
                    ...
                    errorMessage: parsedError ? parsedError : "Error connecting to gateway. Please try again later!",
                });
            }
        });
